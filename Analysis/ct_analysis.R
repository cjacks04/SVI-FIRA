...
#graph to denote the vaccine rate in that census tract
...
#number,we must include the county code as well while searching as different 
#counties have the same census tract number

#dir_path - directory created to store the vaccine plots
#my_data - parsed immunization data

call_ct <- function(dir_path, my_data, ct_name, gender, ethnicity, race, age) {
